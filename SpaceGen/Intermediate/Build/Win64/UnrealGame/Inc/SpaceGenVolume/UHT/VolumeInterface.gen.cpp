...
#include "WorldScapeVolume/Public/VolumeInterface.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AVolumeInterface_Statics::NewProp_AlignToPlanetSurface = { "AlignToPlanetSurface", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(AVolumeInterface), &Z_Construct_UClass_AVolumeInterface_Statics::NewProp_AlignToPlanetSurface_SetBit, METADATA_PARAMS(Z_Construct_UClass_AVolumeInterface_Statics::NewProp_AlignToPlanetSurface_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AVolumeInterface_Statics::NewProp_AlignToPlanetSurface_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AVolumeInterface_Statics::NewProp_SurfaceAlignmentRotationOffset = { "SurfaceAlignmentRotationOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AVolumeInterface, SurfaceAlignmentRotationOffset), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_AVolumeInterface_Statics::NewProp_SurfaceAlignmentRotationOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AVolumeInterface_Statics::NewProp_SurfaceAlignmentRotationOffset_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AVolumeInterface_Statics::NewProp_NeedRefresh = { "NeedRefresh", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(AVolumeInterface), &Z_Construct_UClass_AVolumeInterface_Statics::NewProp_NeedRefresh_SetBit, METADATA_PARAMS(Z_Construct_UClass_AVolumeInterface_Statics::NewProp_NeedRefresh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AVolumeInterface_Statics::NewProp_NeedRefresh_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AVolumeInterface_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AVolumeInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AVolumeInterface_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_VolumeInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_VolumeInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AVolumeInterface, AVolumeInterface::StaticClass, TEXT("AVolumeInterface"), &Z_Registration_Info_UClass_AVolumeInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVolumeInterface), 1607390614U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_VolumeInterface_h_3875760999(TEXT("/Script/WorldScapeVolume"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_VolumeInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_VolumeInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
