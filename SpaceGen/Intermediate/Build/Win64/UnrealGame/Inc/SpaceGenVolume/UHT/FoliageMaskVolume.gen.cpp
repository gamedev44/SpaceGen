...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_FoliageLayerMask_Inner;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_FoliageLayerMask_Inner = { "FoliageLayerMask", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_FoliageLayerMask = { "FoliageLayerMask", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AFoliageMaskVolume, FoliageLayerMask), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_FoliageLayerMask_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_FoliageLayerMask_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_SpawnVolume = { "SpawnVolume", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(AFoliageMaskVolume), &Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_SpawnVolume_SetBit, METADATA_PARAMS(Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_SpawnVolume_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFoliageMaskVolume_Statics::NewProp_SpawnVolume_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AFoliageMaskVolume_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AFoliageMaskVolume_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AFoliageMaskVolume_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolume_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFoliageMaskVolume, AFoliageMaskVolume::StaticClass, TEXT("AFoliageMaskVolume"), &Z_Registration_Info_UClass_AFoliageMaskVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFoliageMaskVolume), 3555658004U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolume_h_731336152(TEXT("/Script/WorldScapeVolume"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolume_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolume_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
