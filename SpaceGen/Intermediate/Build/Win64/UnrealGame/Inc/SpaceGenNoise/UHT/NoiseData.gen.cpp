...
class UScriptStruct* FNoiseData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NoiseData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNoiseData, Z_Construct_UPackage__Script_WorldScapeNoise(), TEXT("NoiseData"));
	}
...
template<> WORLDSCAPENOISE_API UScriptStruct* StaticStruct<FNoiseData>()
{
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_HeightNormalize = { "HeightNormalize", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNoiseData, HeightNormalize), METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_HeightNormalize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_HeightNormalize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Height = { "Height", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNoiseData, Height), METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Height_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Height_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Temperature = { "Temperature", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNoiseData, Temperature), METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Temperature_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Temperature_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Humidity = { "Humidity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNoiseData, Humidity), METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Humidity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Humidity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_WaterMask = { "WaterMask", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNoiseData, WaterMask), METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_WaterMask_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_WaterMask_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_FoliageMask = { "FoliageMask", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNoiseData, FoliageMask), METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_FoliageMask_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_FoliageMask_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Hole = { "Hole", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FNoiseData), &Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Hole_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Hole_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::NewProp_Hole_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNoiseData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FNoiseData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNoiseData_Statics::Struct_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeNoise_Public_NoiseData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeNoise_Public_NoiseData_h_Statics::ScriptStructInfo[] = {
		{ FNoiseData::StaticStruct, Z_Construct_UScriptStruct_FNoiseData_Statics::NewStructOps, TEXT("NoiseData"), &Z_Registration_Info_UScriptStruct_NoiseData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNoiseData), 3564888175U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeNoise_Public_NoiseData_h_3918439425(TEXT("/Script/WorldScapeNoise"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeNoise_Public_NoiseData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeNoise_Public_NoiseData_h_Statics::ScriptStructInfo),
		nullptr, 0);
