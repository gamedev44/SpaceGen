...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_FoliagesClusterUnitList_Inner = { "FoliagesClusterUnitList", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FWorldScapeFoliagesClusterUnit, METADATA_PARAMS(nullptr, 0) }; // 1227289574
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_FoliagesClusterUnitList = { "FoliagesClusterUnitList", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UWorldScapeFoliagesCluster, FoliagesClusterUnitList), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_FoliagesClusterUnitList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_FoliagesClusterUnitList_MetaData)) }; // 1227289574
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_ConstraintAffectFoliages = { "ConstraintAffectFoliages", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UWorldScapeFoliagesCluster), &Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_ConstraintAffectFoliages_SetBit, METADATA_PARAMS(Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_ConstraintAffectFoliages_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::NewProp_ConstraintAffectFoliages_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldScapeFoliagesCluster_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesCluster_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesCluster_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWorldScapeFoliagesCluster, UWorldScapeFoliagesCluster::StaticClass, TEXT("UWorldScapeFoliagesCluster"), &Z_Registration_Info_UClass_UWorldScapeFoliagesCluster, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWorldScapeFoliagesCluster), 678771576U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesCluster_h_1166082402(TEXT("/Script/WorldScapeFoliages"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesCluster_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesCluster_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
