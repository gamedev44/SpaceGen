...
class UScriptStruct* FVegetationTransformArray::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VegetationTransformArray.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVegetationTransformArray, Z_Construct_UPackage__Script_WorldScapeFoliages(), TEXT("VegetationTransformArray"));
	}
...
template<> WORLDSCAPEFOLIAGES_API UScriptStruct* StaticStruct<FVegetationTransformArray>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FVegetationTransformArray_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FVegetationTransformArray_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVegetationTransformArray_Statics::Struct_MetaDataParams))
	};
...
class UScriptStruct* FFoliagesSector::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FoliagesSector.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFoliagesSector, Z_Construct_UPackage__Script_WorldScapeFoliages(), TEXT("FoliagesSector"));
	}
...
template<> WORLDSCAPEFOLIAGES_API UScriptStruct* StaticStruct<FFoliagesSector>()
{
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_HimcMesh_Inner = { "HimcMesh", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_HimcMesh = { "HimcMesh", nullptr, (EPropertyFlags)0x001000800000200d, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FFoliagesSector, HimcMesh), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_HimcMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_HimcMesh_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_ActorsSpawned_Inner = { "ActorsSpawned", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_ActorsSpawned = { "ActorsSpawned", nullptr, (EPropertyFlags)0x0010000000002005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FFoliagesSector, ActorsSpawned), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_ActorsSpawned_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewProp_ActorsSpawned_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFoliagesSector_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliagesSector_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliagesSector_Statics::Struct_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_FoliagesSector_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_FoliagesSector_h_Statics::ScriptStructInfo[] = {
		{ FVegetationTransformArray::StaticStruct, Z_Construct_UScriptStruct_FVegetationTransformArray_Statics::NewStructOps, TEXT("VegetationTransformArray"), &Z_Registration_Info_UScriptStruct_VegetationTransformArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVegetationTransformArray), 3595089300U) },
		{ FFoliagesSector::StaticStruct, Z_Construct_UScriptStruct_FFoliagesSector_Statics::NewStructOps, TEXT("FoliagesSector"), &Z_Registration_Info_UScriptStruct_FoliagesSector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFoliagesSector), 2068955220U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_FoliagesSector_h_1838077672(TEXT("/Script/WorldScapeFoliages"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_FoliagesSector_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeFoliages_Public_FoliagesSector_h_Statics::ScriptStructInfo),
		nullptr, 0);
