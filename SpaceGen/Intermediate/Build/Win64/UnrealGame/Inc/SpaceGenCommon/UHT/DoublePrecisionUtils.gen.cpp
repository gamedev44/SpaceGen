...
class UScriptStruct* FDVector::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DVector.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDVector, Z_Construct_UPackage__Script_WorldScapeCommon(), TEXT("DVector"));
	}
...
template<> WORLDSCAPECOMMON_API UScriptStruct* StaticStruct<FDVector>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDVector_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDVector_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDVector_Statics::Struct_MetaDataParams))
	};
...
class UScriptStruct* FDVector2D::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DVector2D.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDVector2D, Z_Construct_UPackage__Script_WorldScapeCommon(), TEXT("DVector2D"));
	}
...
template<> WORLDSCAPECOMMON_API UScriptStruct* StaticStruct<FDVector2D>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDVector2D_Statics::ReturnStructParams = {
		...
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDVector2D_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDVector2D_Statics::Struct_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeCommon_Public_DoublePrecisionUtils_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeCommon_Public_DoublePrecisionUtils_h_Statics::ScriptStructInfo[] = {
		{ FDVector::StaticStruct, Z_Construct_UScriptStruct_FDVector_Statics::NewStructOps, TEXT("DVector"), &Z_Registration_Info_UScriptStruct_DVector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDVector), 423406736U) },
		{ FDVector2D::StaticStruct, Z_Construct_UScriptStruct_FDVector2D_Statics::NewStructOps, TEXT("DVector2D"), &Z_Registration_Info_UScriptStruct_DVector2D, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDVector2D), 3085061285U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeCommon_Public_DoublePrecisionUtils_h_2896925509(TEXT("/Script/WorldScapeCommon"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeCommon_Public_DoublePrecisionUtils_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_WorldScape_Source_WorldScapeCommon_Public_DoublePrecisionUtils_h_Statics::ScriptStructInfo),
		nullptr, 0);
