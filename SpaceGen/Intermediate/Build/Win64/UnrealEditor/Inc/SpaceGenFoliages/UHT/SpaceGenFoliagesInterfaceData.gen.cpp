...
// End Cross Module References
	...
	static UEnum* EWSFoliagesType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWSFoliagesType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_WorldScapeFoliages_EWSFoliagesType, (UObject*)Z_Construct_UPackage__Script_WorldScapeFoliages(), TEXT("EWSFoliagesType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_WorldScapeFoliages_EWSFoliagesType_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_WorldScapeFoliages_EWSFoliagesType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_WorldScapeFoliages_EWSFoliagesType_Statics::Enum_MetaDataParams)
	};
...
class UScriptStruct* FWorldScapeFoliagesInterfaceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WorldScapeFoliagesInterfaceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWorldScapeFoliagesInterfaceData, (UObject*)Z_Construct_UPackage__Script_WorldScapeFoliages(), TEXT("WorldScapeFoliagesInterfaceData"));
	}
...
template<> WORLDSCAPEFOLIAGES_API UScriptStruct* StaticStruct<FWorldScapeFoliagesInterfaceData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWorldScapeFoliagesInterfaceData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldScapeFoliagesInterfaceData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWorldScapeFoliagesInterfaceData_Statics::Struct_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_Statics::EnumInfo[] = {
		{ EWSFoliagesType_StaticEnum, TEXT("EWSFoliagesType"), &Z_Registration_Info_UEnum_EWSFoliagesType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2104890009U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_125521441(TEXT("/Script/WorldScapeFoliages"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeFoliages_Public_WorldScapeFoliagesInterfaceData_h_Statics::EnumInfo));
