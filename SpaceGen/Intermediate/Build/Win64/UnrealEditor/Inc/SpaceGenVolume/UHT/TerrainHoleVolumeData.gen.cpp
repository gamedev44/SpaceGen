...
class UScriptStruct* FTerrainHoleVolumeData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TerrainHoleVolumeData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTerrainHoleVolumeData, (UObject*)Z_Construct_UPackage__Script_WorldScapeVolume(), TEXT("TerrainHoleVolumeData"));
	}
...
template<> WORLDSCAPEVOLUME_API UScriptStruct* StaticStruct<FTerrainHoleVolumeData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FTerrainHoleVolumeData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTerrainHoleVolumeData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FTerrainHoleVolumeData_Statics::Struct_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_TerrainHoleVolumeData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_TerrainHoleVolumeData_h_Statics::ScriptStructInfo[] = {
		{ FTerrainHoleVolumeData::StaticStruct, Z_Construct_UScriptStruct_FTerrainHoleVolumeData_Statics::NewStructOps, TEXT("TerrainHoleVolumeData"), &Z_Registration_Info_UScriptStruct_TerrainHoleVolumeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTerrainHoleVolumeData), 2358597223U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_TerrainHoleVolumeData_h_4175802508(TEXT("/Script/WorldScapeVolume"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_TerrainHoleVolumeData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_TerrainHoleVolumeData_h_Statics::ScriptStructInfo),
		nullptr, 0);
