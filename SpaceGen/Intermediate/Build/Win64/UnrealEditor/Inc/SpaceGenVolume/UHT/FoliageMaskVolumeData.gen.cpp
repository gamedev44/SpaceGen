...
class UScriptStruct* FFoliageMaskVolumeData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FoliageMaskVolumeData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFoliageMaskVolumeData, (UObject*)Z_Construct_UPackage__Script_WorldScapeVolume(), TEXT("FoliageMaskVolumeData"));
	}
...
template<> WORLDSCAPEVOLUME_API UScriptStruct* StaticStruct<FFoliageMaskVolumeData>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FFoliageMaskVolumeData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliageMaskVolumeData_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FFoliageMaskVolumeData_Statics::Struct_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolumeData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolumeData_h_Statics::ScriptStructInfo[] = {
		{ FFoliageMaskVolumeData::StaticStruct, Z_Construct_UScriptStruct_FFoliageMaskVolumeData_Statics::NewStructOps, TEXT("FoliageMaskVolumeData"), &Z_Registration_Info_UScriptStruct_FoliageMaskVolumeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFoliageMaskVolumeData), 3315605570U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolumeData_h_226677276(TEXT("/Script/WorldScapeVolume"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolumeData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_FoliageMaskVolumeData_h_Statics::ScriptStructInfo),
		nullptr, 0);
