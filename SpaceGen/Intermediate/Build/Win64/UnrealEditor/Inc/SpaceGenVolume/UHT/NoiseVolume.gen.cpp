...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANoiseVolume_Statics::NewProp_EdgeFalloff = { "EdgeFalloff", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANoiseVolume, EdgeFalloff), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::NewProp_EdgeFalloff_MetaData), Z_Construct_UClass_ANoiseVolume_Statics::NewProp_EdgeFalloff_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseScale = { "NoiseScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANoiseVolume, NoiseScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseScale_MetaData), Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseScale_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseIntensity = { "NoiseIntensity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANoiseVolume, NoiseIntensity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseIntensity_MetaData), Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseIntensity_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseHeightOffset = { "NoiseHeightOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANoiseVolume, NoiseHeightOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseHeightOffset_MetaData), Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseHeightOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ANoiseVolume_Statics::NewProp_Seed = { "Seed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANoiseVolume, Seed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::NewProp_Seed_MetaData), Z_Construct_UClass_ANoiseVolume_Statics::NewProp_Seed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseOffset = { "NoiseOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANoiseVolume, NoiseOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseOffset_MetaData), Z_Construct_UClass_ANoiseVolume_Statics::NewProp_NoiseOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANoiseVolume_Statics::NewProp_WorldScapeNoise = { "WorldScapeNoise", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANoiseVolume, WorldScapeNoise), Z_Construct_UClass_UWorldScapeNoiseClass_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::NewProp_WorldScapeNoise_MetaData), Z_Construct_UClass_ANoiseVolume_Statics::NewProp_WorldScapeNoise_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ANoiseVolume_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::Class_MetaDataParams), Z_Construct_UClass_ANoiseVolume_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANoiseVolume_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_NoiseVolume_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_NoiseVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANoiseVolume, ANoiseVolume::StaticClass, TEXT("ANoiseVolume"), &Z_Registration_Info_UClass_ANoiseVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANoiseVolume), 3216404773U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_NoiseVolume_h_2049688094(TEXT("/Script/WorldScapeVolume"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_NoiseVolume_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_NoiseVolume_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
