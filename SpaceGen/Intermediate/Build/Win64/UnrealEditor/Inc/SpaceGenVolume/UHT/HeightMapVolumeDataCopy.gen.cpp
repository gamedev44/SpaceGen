...
class UScriptStruct* FHeightMapVolumeDataCopy::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HeightMapVolumeDataCopy.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHeightMapVolumeDataCopy, (UObject*)Z_Construct_UPackage__Script_WorldScapeVolume(), TEXT("HeightMapVolumeDataCopy"));
	}
...
template<> WORLDSCAPEVOLUME_API UScriptStruct* StaticStruct<FHeightMapVolumeDataCopy>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHeightMapVolumeDataCopy_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHeightMapVolumeDataCopy_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FHeightMapVolumeDataCopy_Statics::Struct_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_HeightMapVolumeDataCopy_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_HeightMapVolumeDataCopy_h_Statics::ScriptStructInfo[] = {
		{ FHeightMapVolumeDataCopy::StaticStruct, Z_Construct_UScriptStruct_FHeightMapVolumeDataCopy_Statics::NewStructOps, TEXT("HeightMapVolumeDataCopy"), &Z_Registration_Info_UScriptStruct_HeightMapVolumeDataCopy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHeightMapVolumeDataCopy), 316203807U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_HeightMapVolumeDataCopy_h_826089209(TEXT("/Script/WorldScapeVolume"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_HeightMapVolumeDataCopy_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeVolume_Public_HeightMapVolumeDataCopy_h_Statics::ScriptStructInfo),
		nullptr, 0);
