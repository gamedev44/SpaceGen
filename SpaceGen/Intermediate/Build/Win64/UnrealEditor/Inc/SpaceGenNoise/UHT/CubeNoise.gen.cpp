...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_TemperatureOffset = { "TemperatureOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCubeNoiseParameter, TemperatureOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_TemperatureOffset_MetaData), Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_TemperatureOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_HumidityOffset = { "HumidityOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCubeNoiseParameter, HumidityOffset), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_HumidityOffset_MetaData), Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_HumidityOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_HumidityScale = { "HumidityScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCubeNoiseParameter, HumidityScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_HumidityScale_MetaData), Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_HumidityScale_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_CubeWidth = { "CubeWidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCubeNoiseParameter, CubeWidth), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_CubeWidth_MetaData), Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_CubeWidth_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_CubeHeight = { "CubeHeight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCubeNoiseParameter, CubeHeight), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_CubeHeight_MetaData), Z_Construct_UClass_UCubeNoiseParameter_Statics::NewProp_CubeHeight_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCubeNoiseParameter_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::Class_MetaDataParams), Z_Construct_UClass_UCubeNoiseParameter_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoiseParameter_Statics::PropPointers) < 2048);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoise_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCubeNoise_Statics::NewProp_NoiseParameters = { "NoiseParameters", nullptr, (EPropertyFlags)0x001000000008000d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCubeNoise, NoiseParameters), Z_Construct_UClass_UCubeNoiseParameter_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoise_Statics::NewProp_NoiseParameters_MetaData), Z_Construct_UClass_UCubeNoise_Statics::NewProp_NoiseParameters_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCubeNoise_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoise_Statics::Class_MetaDataParams), Z_Construct_UClass_UCubeNoise_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UCubeNoise_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeNoise_Public_CubeNoise_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeNoise_Public_CubeNoise_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCubeNoiseParameter, UCubeNoiseParameter::StaticClass, TEXT("UCubeNoiseParameter"), &Z_Registration_Info_UClass_UCubeNoiseParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCubeNoiseParameter), 4216338666U) },
		{ Z_Construct_UClass_UCubeNoise, UCubeNoise::StaticClass, TEXT("UCubeNoise"), &Z_Registration_Info_UClass_UCubeNoise, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCubeNoise), 2182529267U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeNoise_Public_CubeNoise_h_2398891326(TEXT("/Script/WorldScapeNoise"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeNoise_Public_CubeNoise_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Marketplace_WorldScape_Source_WorldScapeNoise_Public_CubeNoise_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
